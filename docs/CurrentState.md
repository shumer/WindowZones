...
1. Проверить завершение Checks CI35454030735, исправить ошибки при наличии.
...
3. После успешного CI и всех секретов создать tagv0.1.0 на проверенном commit, запустить Signed release candidate с build1. Проверить notarization Accepted и draft assets.
